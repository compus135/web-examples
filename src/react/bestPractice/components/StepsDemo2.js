...
const Step2 = ({ age, onClickPre, onSubmit }) => {
  return age < 10 ? (
    <Step2Child onClickPre={onClickPre} onSubmit={onSubmit} />
  ) : (
    <Step2Adault onClickPre={onClickPre} onSubmit={onSubmit} />
  );
};
